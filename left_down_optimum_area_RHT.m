% x plus
% y moins
function I = left_down_optimum_area_RHT(I, xa,ya,xb,yb,xc,yc,xd,yd)
...
%        disp(y1d);
        ...
        I = left_down_optimum_area_RHT(I, x1a,y1a,x1b,y1b,x1c,y1c,x1d,y1d);
...
%        disp(y2d);
        ...
        I = left_down_optimum_area_RHT(I, x2a,y2a,x2b,y2b,x2c,y2c,x2d,y2d);
    end
end