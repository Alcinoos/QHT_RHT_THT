function I = left_up_optimum_area_QHT(I, xa,ya,xb,yb,xc,yc,xd,yd)
...
%         disp(Temp); 
 ...
 %for part 1        
        ...
        x1d =  xa+n;
        y1d = yb+n;
        I = left_up_optimum_area_QHT(I, x1a,y1a,x1b,y1b,x1c,y1c,x1d,y1d);
 ...
 % for part 2       
        ...
        I = left_up_optimum_area_QHT(I, x2a,y2a,x2b,y2b,x2c,y2c,x2d,y2d);
    end
end